package com.ctrip.car.osd.framework.async.wrapper;

import com.ctrip.car.osd.framework.async.callback.DefaultCallback;
import com.ctrip.car.osd.framework.async.callback.ICallback;
import com.ctrip.car.osd.framework.async.callback.IWorker;
import com.ctrip.car.osd.framework.async.exception.SkippedException;
import com.ctrip.car.osd.framework.async.executor.timer.SystemClock;
import com.ctrip.car.osd.framework.async.worker.DependWrapper;
...
public class WorkerWrapper<T, V> {
    ...
    private WorkResult<V> workerDoJob() {
        ...
        try {
            ...
            workResult.setResult(Objects.isNull(resultValue) ? worker.defaultValue() : resultValue);
            //回调成功
    ...
    private WorkResult<V> defaultStateResult() {
        workResult.setResultState(ResultState.DEFAULT);
        workResult.setResult(worker.defaultValue());
        return workResult;
    }
