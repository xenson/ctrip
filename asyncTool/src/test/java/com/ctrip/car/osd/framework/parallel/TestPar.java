...
//        Async.beginWork(1000, workerWrapper, workerWrapper1, workerWrapper2);
     ...
     * 2
     */
    private static void testMulti() throws Exception {
        ParWorker w = new ParWorker();
        ParWorker1 w1 = new ParWorker1();
        ParWorker2 w2 = new ParWorker2();
     ...
     * 2
     */
    private static void testMultiReverse() throws Exception {
        ParWorker w = new ParWorker();
        ParWorker1 w1 = new ParWorker1();
        ParWorker2 w2 = new ParWorker2();
     ...
     * 2
     */
    private static void testMultiError() throws Exception {
        ParWorker w = new ParWorker();
        ParWorker1 w1 = new ParWorker1();
        ParWorker2 w2 = new ParWorker2();
     ...
     * 2
     */
    private static void testMulti3() throws Exception {
        ParWorker w = new ParWorker();
        ParWorker1 w1 = new ParWorker1();
        ParWorker2 w2 = new ParWorker2();
...
//        Async.beginWork(2100, workerWrapper);
     ...
     * 2
     */
    private static void testMulti3Reverse() throws Exception {
        ParWorker w = new ParWorker();
        ParWorker1 w1 = new ParWorker1();
        ParWorker2 w2 = new ParWorker2();
        ParWorker3 w3 = new ParWorker3();
...
//        Async.beginWork(2100, workerWrapper);
     ...
     * 执行结果0，1，2，3
     */
    private static void testMulti4() throws Exception {
        ParWorker w = new ParWorker();
        ParWorker1 w1 = new ParWorker1();
...
//        Async.beginWork(2900, workerWrapper);
     ...
     * 执行结果0，1，2，3
     */
    private static void testMulti4Reverse() throws Exception {
        ParWorker w = new ParWorker();
        ParWorker1 w1 = new ParWorker1();
...
//        Async.beginWork(2900, workerWrapper);
    ...
    private static void testMulti5() throws Exception {
        ParWorker w = new ParWorker();
        ParWorker1 w1 = new ParWorker1();
     ...
     * 2，3分别是500、400.3执行完毕后，1才执行完
     */
    private static void testMulti5Reverse() throws Exception {
        ParWorker w = new ParWorker();
        ParWorker1 w1 = new ParWorker1();
     ...
     */
    private static void testMulti6() throws Exception {
        ParWorker w = new ParWorker();
        ParWorker1 w1 = new ParWorker1();
     ...
     */
    @Test
    public  void testMulti7() throws Exception {
        ParWorker w = new ParWorker();
        ParWorker1 w1 = new ParWorker1();
        ParWorker2 w2 = new ParWorker2();
        ParWorker3 w3 = new ParWorker3();
     ...
     * b、c
     */
    private static void testMulti8() throws Exception {
        ParWorker w = new ParWorker();
        ParWorker1 w1 = new ParWorker1();
     ...
     */
    private static void testMulti9() throws Exception {
        ParWorker1 w1 = new ParWorker1();
...
//        w1.setSleepTime(1100);
     ...
     * w1和w并行，w执行完后就执行last，此时b、c还没开始，b、c就不需要执行了
     */
    private static void testMulti9Reverse() throws Exception {
        ParWorker1 w1 = new ParWorker1();
        //注意这里，如果w1的执行时间比w长，那么w2和w3肯定不走。 如果w1和w执行时间一样长，多运行几次，会发现w2有时走有时不走
//        w1.setSleepTime(1100);
