...
public class OpslabConfig {
    ...
    static {
        ...
        try (InputStream inputStream = contextClassLoader.getResource("appconfig.properties").openStream()) {
            ...
            //获取非jar包内的配置信息
            try {
                String config_file = new File(contextClassLoader.getResource("appconfig.properties").toURI()).getPath();
