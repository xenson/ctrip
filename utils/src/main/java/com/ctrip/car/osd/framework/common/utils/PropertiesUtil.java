...
public final class PropertiesUtil {
    ...
    public final static Map<String,String> properties(InputStreamReader in){
        Map<String,String> map = new HashMap<>();
        Properties pps = new Properties();
        try {
            pps.load(in);
...
//        Properties pps = new Properties();
     ...
     * @return 返回所有的属性 key:value<>key:value
     */
    public final static Map<String,String> GetAllProperties(String filePath, String charsetName) throws IOException {
        Map<String,String> map = new HashMap<>();
//        Properties pps = new Properties();
