...
import com.ctrip.car.osd.framework.common.utils.algorithmImpl.BCConvert;
import com.ctrip.car.osd.framework.common.utils.algorithmImpl.StringImpl;
...
public final class StringUtil {
    ...
    public  static String joinString(String[] array, String symbol) {
        ...
        if (array != null) {
            ...
            if (result.length() > 1 && ValidUtil.valid(symbol)) {
    ...
    public  static String join(String linkStr,String ... strs){
        StringBuffer result = new StringBuffer();
            ...
            if (result.length() > 1 && ValidUtil.valid(linkStr)) {
    ...
    public  static boolean isIn(String substring, String[] source) {
        if(isEmpty(substring) || !ValidUtil.valid(source)){
            return false;
        }
        for (String t:source) {
