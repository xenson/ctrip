package com.ctrip.car.osd.framework.common.utils.algorithmImpl;

import com.ctrip.car.osd.framework.common.utils.FileUtil;
...
public class FileEncodingUtil {
    ...
    public static void convert(File file, String fromCharsetName, String toCharsetName, FilenameFilter filter) {
        if (file.isDirectory()) {
            List<File> list = ValidUtil.valid(filter) ? FileUtil.listFileFilter(file, filter) :
